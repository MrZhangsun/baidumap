...
public class BaiduStorageTest {
	...
	public void demo2() throws IOException {
		...
		HttpGet httpGet = new HttpGet(
				"http://api.map.baidu.com/geodata/v3/geotable/list?ak=oAlv32CIW7KgAdaHlGmzIajbDtodUBY4");
	...
	public void demo5() throws IOException {
		HttpClient httpClient = HttpClients.createDefault();
		HttpGet httpGet = new HttpGet(
				"http://api.map.baidu.com/geodata/v3/column/list?geotable_id=153944&ak=oAlv32CIW7KgAdaHlGmzIajbDtodUBY4");
